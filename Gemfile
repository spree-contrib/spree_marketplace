...
group :development, :test do
  ...
  gem 'spree_group_pricing',    github: 'spree-contrib/spree_group_pricing',    branch: spree_branch
  gem 'spree_related_products', github: 'spree-contrib/spree_related_products', branch: spree_branch
end
